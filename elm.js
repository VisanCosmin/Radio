...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{au: false, aw: r.aw, aB: r.aB, U: r.U, aG: r.aG, aQ: r.aQ, ao: r.ao, aT: r.aT}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{aw: $elm$http$Http$emptyBody, aB: r.aB, U: _List_Nil, aG: 'GET', aQ: $elm$core$Maybe$Nothing, ao: $elm$core$Maybe$Nothing, aT: r.aT});
};
var $elm$json$Json$Decode$field = _Json_decodeField;
var $elm$json$Json$Decode$list = _Json_decodeList;
var $author$project$Main$Station = F5(
	function (name, stream, thumbnail, country, categories) {
		return {ax: categories, P: country, G: name, M: stream, B: thumbnail};
	});
var $author$project$Main$Country = F2(
	function (name, thumbnail) {
		return {G: name, B: thumbnail};
	});
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Main$countryDecoder = A3(
	$elm$json$Json$Decode$map2,
	$author$project$Main$Country,
	A2($elm$json$Json$Decode$field, 'name', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'thumbnail', $elm$json$Json$Decode$string));
var $elm$json$Json$Decode$map5 = _Json_map5;
var $author$project$Main$stationDecoder = A6(
	$elm$json$Json$Decode$map5,
	$author$project$Main$Station,
	A2($elm$json$Json$Decode$field, 'name', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'stream', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'thumbnail', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'country', $author$project$Main$countryDecoder),
	A2(
		$elm$json$Json$Decode$field,
		'categories',
		$elm$json$Json$Decode$list($elm$json$Json$Decode$string)));
var $author$project$Main$listDecoder = A2(
	$elm$json$Json$Decode$field,
	'stations',
...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		...
		$elm$http$Http$get(
			{
				aB: A2($elm$http$Http$expectJson, $author$project$Main$GotResult, $author$project$Main$listDecoder),
				aT: 'https://visancosmin.github.io/Radio/stations.json'
			}));
};
...
var $author$project$Main$update = F2(
	function (msg, model) {
		if (!msg.$) {
			...
			if (res.$ === 1) {
				return _Utils_Tuple2(
					$author$project$Main$Loaded(_List_Nil),
					$elm$core$Platform$Cmd$none);
			} else {
				var s = res.a;
				return _Utils_Tuple2(
					$author$project$Main$Loaded(s),
					$elm$core$Platform$Cmd$none);
			}
		}
	});
...
var $author$project$Main$stationToDiv = function (station) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				$elm$html$Html$text(station.G),
				A2($elm$html$Html$br, _List_Nil, _List_Nil),
				$elm$html$Html$text(station.M),
				A2($elm$html$Html$br, _List_Nil, _List_Nil),
				$elm$html$Html$text(station.B),
				A2($elm$html$Html$br, _List_Nil, _List_Nil),
				A2(
				$elm$html$Html$img,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$src(station.B),
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$src(station.P.B),
						$elm$html$Html$Attributes$width(100)
					]),
				_List_Nil),
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$src(station.M),
...
var $author$project$Main$view = function (model) {
	if (!model.$) {
		...
		return A2(
			$elm$html$Html$div,
			_List_Nil,
			A2($elm$core$List$map, $author$project$Main$stationToDiv, res));
	}
};
